...
import ActiveIngredientInput from '../forms/ActiveIngredientInput';
import CustomSelect from '../forms/CustomSelect';
import UnitSelect from '../forms/UnitSelect';
import BrandSelect from '../forms/BrandSelect';
...
export default function ProductEditModal({ product, isOpen, onClose, onSave }) {
    ...
    const saveProduct = async (data) => {
        const payload = {
            ...
            multiplier: data.multiplier !== '' && data.multiplier !== null && data.multiplier !== undefined ? Number(data.multiplier) : 1,
            cost_price: data.cost_price !== '' && data.cost_price !== null && data.cost_price !== undefined ? Number(data.cost_price) : 0,
            sale_price: data.sale_price !== '' && data.sale_price !== null && data.sale_price !== undefined ? Number(data.sale_price) : 0,
            stock: data.stock !== '' && data.stock !== null && data.stock !== undefined ? Number(data.stock) : 0,
            min_stock: data.min_stock !== '' && data.min_stock !== null && data.min_stock !== undefined ? Number(data.min_stock) : 0,
            accounting_price: data.accounting_price !== '' && data.accounting_price !== null && data.accounting_price !== undefined ? Number(data.accounting_price) : 0,
            accounting_stock: data.accounting_stock !== '' && data.accounting_stock !== null && data.accounting_stock !== undefined ? Number(data.accounting_stock) : 0,
            bulk_quantity: (data.bulk_quantity === '' || data.bulk_quantity === null || data.bulk_quantity === undefined) ? null : Number(data.bulk_quantity),
            bulk_price: (data.bulk_price === '' || data.bulk_price === null || data.bulk_price === undefined) ? null : Number(data.bulk_price),
        };
        if (product?.id) {
                                            ...
                                            <m.div key="basic" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 10 }} className="space-y-6">
                                                <div className="grid grid-cols-12 gap-6 bg-card/40 p-6 rounded-2xl border border-border">
                                                    ...
                                                    <div className="col-span-6">
                                                        ...
                                                        <CustomSelect
                                                            className="w-full"
                                                            buttonClassName="input-premium w-full p-3 font-bold text-sm border border-border focus:border-primary"
                                                ...
                                                <div className="grid grid-cols-12 gap-6 bg-card/40 p-6 rounded-3xl border border-border">
                                                    <div className="col-span-3">
                                                        ...
                                                        <UnitSelect
                                                            ...
                                                            buttonClassName="input-premium w-full p-3 font-black text-sm border border-border focus:border-primary"
                                                        />
                                                    </div>
                                                    <div className="col-span-3">
                                                     ...
                                                     <div className="col-span-12 border-t border-border my-2"></div>
                                                            <div className="col-span-6">
                                                                ...
                                                                <UnitSelect
                                                                    ...
                                                                    onChange={val => setFormData({ ...formData, secondary_unit: val })}
                                                                    existingProducts={allProducts}
                                                                    placeholder="Ví dụ: Thùng, Lốc..."
                                                                    buttonClassName="input-premium w-full p-3 font-bold text-sm border border-border focus:border-primary"
                                                                />
                                                            </div>
                                                            <div className="col-span-6">
