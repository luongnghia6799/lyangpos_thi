...
function POSPage({
        ...
        `}</style><div className="flex-1 flex flex-col overflow-hidden no-print"><div className="p-3.5 px-5 flex gap-5 items-center justify-between print:hidden transition-colors relative z-[3000] bg-transparent"><div className="flex items-center gap-3 shrink-0"><div className="flex items-center gap-3 group cursor-default relative"><div className="flex flex-col"><h1 className="text-2xl font-black text-[#2d5016] dark:text-[#d4a574] uppercase tracking-tighter flex items-center gap-2 leading-none" style={{ color: cartColorConfig?.accentColor && cartColorConfig.accentColor !== 'default' ? cartColorConfig.accentColor : undefined }}>BÁN HÀNG</h1><span className="text-[10px] font-bold text-[#8b6f47]/70 dark:text-[#d4a574]/60 tracking-wider">by LyangNghia</span></div><P mode="popLayout" initial={!1}><x.div key={le?.id || Ce || "draft"} initial={{
                  ...
                  Xr(!0);
                    ...
                    scale: 0.98
                      ...
                      }} className="flex items-center justify-between px-3 py-2.5 text-xs font-black text-slate-700 dark:text-slate-200 hover:bg-emerald-500/10 hover:text-primary dark:hover:text-emerald-400 rounded-2xl transition-all group/menu-item w-full text-left"><div className="flex items-center gap-3"><div className="w-8 h-8 rounded-xl bg-emerald-500/10 text-primary dark:text-emerald-400 flex items-center justify-center group-hover/menu-item:scale-110 transition-transform"><Palette size={16} strokeWidth={2.5} /></div><div className="flex flex-col text-left"><span className="uppercase tracking-tight text-[11px]">Tùy chỉnh giao diện giỏ hàng</span><span className="text-[9px] font-bold text-slate-400 lowercase tracking-normal">màu sắc, viền, mờ kính, mascot</span></div></div><div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-extrabold bg-emerald-500/10 px-2 py-0.5 rounded-md">Mở</div></button><button onClick={() => {
                        Ct(!1), fs(!0);
                                        ...
                                        Xt(s), za({
                                          ...
                                          o > -1 ? (n[o].quantity += d, n[o].secondary_qty = n[o].quantity / (n[o].multiplier || 1), n.splice(l, 1)) : (n[l] = {
                                            ...
                                            is_manual_price: !1
                                              ...
                                              color: s === It ? Mt.accent : Mt.main
                                            }}>{z(r.sale_price)}</div><div className="text-[10px] font-black text-slate-500 dark:text-slate-500 uppercase tracking-widest opacity-80">NHẬP CUỐI: {z(r.latest_cost_price)}</div></div></div></div>)}</div></div>}{t.active_ingredient && (
  <div className="pointer-events-none absolute left-0 bottom-full mb-2.5 opacity-0 translate-y-2 scale-95 group-hover/search-row:opacity-100 group-hover/search-row:translate-y-0 group-hover/search-row:scale-100 transition-all duration-200 ease-out z-[4000] min-w-[260px] max-w-[360px] bg-[#faf8f3]/95 dark:bg-[#141d13]/95 backdrop-blur-xl border border-[#8b6f47]/30 dark:border-emerald-500/30 rounded-2xl p-3 shadow-[0_16px_36px_-6px_rgba(45,80,22,0.22)] dark:shadow-[0_16px_36px_-6px_rgba(0,0,0,0.8)]">
    ...
    <div className="absolute -bottom-1.5 left-6 w-3 h-3 rotate-45 bg-[#faf8f3] dark:bg-[#141d13] border-r border-b border-[#8b6f47]/30 dark:border-emerald-500/30" />
                  ...
                  }} className="absolute bottom-3 right-3 z-[110] pointer-events-none flex items-center gap-2.5">{I === "Cash" && <div style={getBubbleComputedStyle(cartColorConfig, 'cash')} className="pointer-events-auto flex items-center bg-[#fbf9f4] dark:bg-[#1a1e17] backdrop-blur-xl p-3 pr-5 rounded-2xl border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/35 shadow-[0_10px_22px_-2px_rgba(139,111,71,0.24)] dark:shadow-[0_12px_24px_-2px_rgba(0,0,0,0.7)] hover:shadow-[0_14px_28px_-2px_rgba(139,111,71,0.3)] hover:border-[#2d5016] dark:hover:border-emerald-400 group/cash-calculator relative min-w-[200px] hover:scale-[1.02] transition-all duration-300"><div style={getBubbleBadgeStyle(cartColorConfig, 'cash')} className="w-10 h-10 rounded-xl flex items-center justify-center shadow-md shrink-0 group-hover/cash-calculator:rotate-12 transition-transform"><Comp_oa size={20} style={{ color: getBubbleBadgeStyle(cartColorConfig, 'cash').color || '#ffffff' }} /></div><div className="flex flex-col ml-3"><span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#8b6f47] dark:text-[#d4a574] mb-0.5 whitespace-nowrap" style={getBubbleComputedStyle(cartColorConfig, "cash").color ? { color: getBubbleComputedStyle(cartColorConfig, "cash").color } : undefined}>Khách đưa (F1)</span><div className="flex items-center gap-2.5"><div className="relative flex items-center min-w-[70px] group/input-wrapper h-full"><span className="invisible whitespace-pre font-black text-xl px-1 pointer-events-none tabular-nums select-none">{z(V) || "0"}</span><input id="cash-given-compact" ref={xr} type="text" style={getBubbleComputedStyle(cartColorConfig, "cash").color ? { color: getBubbleComputedStyle(cartColorConfig, "cash").color } : undefined} className="absolute inset-0 w-full h-full bg-transparent border-b-2 border-[#8b6f47]/30 focus:border-[#2d5016] dark:focus:border-emerald-400 outline-none font-black text-xl text-[#2d5016] dark:text-emerald-400 p-0 tabular-nums transition-all z-10" value={z(V)} autoComplete="off" onChange={t => Ye(parseFloat(t.target.value.replace(/,/g, "")) || 0)} onFocus={t => t.target.select()} /></div>{V > 0 && <div className="flex flex-col items-end min-w-[85px] border-l border-[#8b6f47]/20 dark:border-[#d4a574]/20 pl-3 py-0.5"><span className="text-[8px] font-black text-[#8b6f47] dark:text-[#d4a574] uppercase leading-none mb-0.5 whitespace-nowrap" style={getBubbleComputedStyle(cartColorConfig, "cash").color ? { color: getBubbleComputedStyle(cartColorConfig, "cash").color } : undefined}>Tiền thối</span><span className={c("text-xl font-black tabular-nums transition-colors", V > $ ? "text-emerald-600 dark:text-emerald-400" : "text-gray-400 opacity-50")}>{z(Math.max(0, V - $))}</span></div>}</div></div></div>}{(p || g === "remote_inspect") && <div style={getBubbleComputedStyle(cartColorConfig, 'payment')} className="w-[155px] pointer-events-auto flex items-center bg-[#fbf9f4] dark:bg-[#1a1e17] backdrop-blur-xl p-1 rounded-2xl border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/35 shadow-[0_10px_22px_-2px_rgba(139,111,71,0.24)] dark:shadow-[0_12px_24px_-2px_rgba(0,0,0,0.7)] hover:shadow-[0_14px_28px_-2px_rgba(139,111,71,0.3)] hover:border-[#2d5016] dark:hover:border-emerald-400 group/payment-toggle relative h-[56px] transition-all duration-300"><x.div layout={!0} className="absolute inset-y-1 rounded-xl shadow-md z-0" style={{
                        width: "calc(50% - 4px)",
              ...
              damping: 30
                      ...
                      scale: 0.9
                          ...
                          p ? setIsHistoryPanelOpen(true) : Et.current?.focus();
                                  ...
                                  scale: 0.96
                                    ...
                                    opacity: 0,
                                    height: 0
                                  }} className="relative overflow-hidden flex items-center justify-between p-2.5 pl-3.5 bg-white/80 dark:bg-black/40 border-2 border-blue-400/40 rounded-xl shadow-xs"><div className="text-[9px] font-black text-blue-600 dark:text-blue-400 uppercase whitespace-nowrap">TK Nhận:</div><Comp_zn className="w-full min-w-0 border-none shadow-none text-right justify-end font-bold text-xs bg-transparent text-slate-800 dark:text-white outline-none" value={ss} onChange={t => ns(t.target.value)} options={ln.map(t => ({
                                      value: t.id,
                                      label: `${t.bank_name} - ${t.account_number}`
                                    }))} /></x.div>}</P><div className="relative bg-white/80 dark:bg-black/40 border-2 border-[#8b6f47]/30 dark:border-emerald-500/40 focus-within:border-[#2d5016] dark:focus-within:border-emerald-400 focus-within:ring-2 focus-within:ring-[#2d5016]/10 rounded-xl shadow-xs"><div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] font-black text-[#8b6f47] dark:text-emerald-300 uppercase z-10">KHÁCH ĐƯA (F1):</div><input ref={xr} type="number" className="w-full p-2.5 pl-36 text-right rounded-xl font-black text-xl outline-none bg-transparent text-[#2d5016] dark:text-white tabular-nums" value={V === 0 ? "" : V} placeholder="0" id="cash-given-sidebar" autoComplete="off" onChange={t => Ye(parseFloat(t.target.value) || 0)} onFocus={t => t.target.select()} /></div><div className="relative group/pay-sidebar bg-white/80 dark:bg-black/40 border-2 border-[#8b6f47]/30 dark:border-emerald-500/40 focus-within:border-[#2d5016] dark:focus-within:border-emerald-400 focus-within:ring-2 focus-within:ring-[#2d5016]/10 rounded-xl shadow-xs"><div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[10px] font-black text-[#8b6f47] dark:text-emerald-300 uppercase z-10">THANH TOÁN:</div><input type="text" readOnly={I === "Cash" || I === "Pending"} className={c("w-full p-2.5 pl-28 pr-4 text-right rounded-xl font-black text-xl outline-none bg-transparent tabular-nums", I === "Cash" || I === "Pending" ? "text-slate-400 dark:text-emerald-400/50 cursor-not-allowed" : "text-[#2d5016] dark:text-white")} value={z(oe)} autoComplete="off" onChange={t => re(parseFloat(t.target.value.replace(/,/g, "")) || 0)} /><P>{(I === "Debt" || I === "Transfer") && <x.button initial={{
                                    opacity: 0
                                  }} animate={{
                                    opacity: 1
                                  }} exit={{
                            ...
                            scale: 0.95
                          }} disabled={y.length === 0} onClick={wr} className="flex-1 bg-white/80 dark:bg-[#1a1e17] text-[#8b6f47] dark:text-[#d4a574] border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 hover:bg-[#8b6f47] hover:text-white rounded-xl font-black py-2.5 text-sm uppercase tracking-widest flex items-center justify-center gap-1.5 transition-colors shadow-sm disabled:opacity-40 cursor-pointer"><Comp_jt size={18} strokeWidth={2.5} /><span>TẠM</span></x.button><x.button whileHover={{
                            scale: 1.02
                          }} whileTap={{
                            scale: 0.95
                          }} disabled={y.length === 0 || Be} onClick={() => Re(!1)} className="flex-1 bg-white/80 dark:bg-[#1a1e17] text-[#2d5016] dark:text-emerald-400 border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 hover:bg-[#2d5016] hover:text-white rounded-xl font-black py-2.5 text-sm uppercase tracking-widest flex items-center justify-center gap-1.5 transition-colors shadow-sm disabled:opacity-40 cursor-pointer"><Er size={18} strokeWidth={2.5} /><span>LƯU</span></x.button></div><x.button whileHover={{
                          scale: 1.01
                        }} whileTap={{
                          scale: 0.98
                    ...
                    mass: 1
                        ...
                        scale: 0.92
                      }} onClick={() => ja(!0)} style={getButtonComputedStyle(cartColorConfig, 'quick_debt')} className="w-14 h-14 bg-[#fbf9f4] dark:bg-[#1a1e17] text-[#8b6f47] dark:text-[#d4a574] rounded-2xl flex items-center justify-center border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 hover:border-[#2d5016] dark:hover:border-emerald-400 hover:text-[#2d5016] dark:hover:text-emerald-400 hover:bg-[#8b6f47]/10 transition-all group/qd relative overflow-hidden shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Ghi nợ nhanh"><Hs size={22} strokeWidth={2.5} className="relative z-20" style={getButtonComputedStyle(cartColorConfig, "quick_debt").color ? { color: getButtonComputedStyle(cartColorConfig, "quick_debt").color } : undefined} /></x.button>}{p && <x.button whileHover={{
                        scale: 1.08,
                        rotate: -5
                      }} whileTap={{
                        scale: 0.92
                      }} onClick={() => _a(!0)} style={getButtonComputedStyle(cartColorConfig, 'quick_voucher')} className="w-14 h-14 bg-[#fbf9f4] dark:bg-[#1a1e17] text-[#8b6f47] dark:text-[#d4a574] rounded-2xl flex items-center justify-center border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 hover:border-[#2d5016] dark:hover:border-emerald-400 hover:text-[#2d5016] dark:hover:text-emerald-400 hover:bg-[#8b6f47]/10 transition-all group/qv relative overflow-hidden shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Lập phiếu nhanh"><Ks size={22} strokeWidth={2.5} className="relative z-20" style={getButtonComputedStyle(cartColorConfig, "quick_voucher").color ? { color: getButtonComputedStyle(cartColorConfig, "quick_voucher").color } : undefined} /></x.button>}<div className="relative group/ship-mini"><x.button whileHover={{
                          scale: 1.08,
                          rotate: 8
                        }} whileTap={{
                          scale: 0.92
                        }} onClick={() => vn(!0)} className="w-14 h-14 bg-[#fbf9f4] dark:bg-[#1a1e17] text-[#2d5016] dark:text-emerald-400 rounded-2xl flex items-center justify-center border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 hover:border-[#2d5016] dark:hover:border-emerald-400 hover:bg-[#2d5016]/10 hover:text-[#2d5016] transition-all group/ship relative overflow-hidden shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Quản lý giao hàng"><Comp_u_t size={22} strokeWidth={2.5} className="relative z-20" /></x.button>{D > 0 && <div className="absolute -top-1.5 -right-2 min-w-[20px] h-[20px] bg-gradient-to-tr from-[#2d5016] to-emerald-600 text-white text-[9px] font-black tracking-wider rounded-full border border-white/40 shadow-xs flex items-center justify-center px-1.5 z-20"><span className="relative flex h-1.5 w-1.5 mr-0.5"><span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-emerald-200" /></span>{D}</div>}</div></div><div className="flex-1 flex items-center justify-center w-full min-h-[60px] relative"><x.button whileHover={{
                        scale: 1.08,
                        x: -2
                      }} whileTap={{
                        scale: 0.92
                      }} onClick={() => en(!0)} style={getButtonComputedStyle(cartColorConfig, 'toggle')} className="w-14 h-14 bg-[#fbf9f4] dark:bg-[#1a1e17] text-[#8b6f47] dark:text-[#d4a574] rounded-2xl flex items-center justify-center border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 hover:border-[#2d5016] dark:hover:border-emerald-400 hover:text-[#2d5016] dark:hover:text-emerald-400 hover:bg-[#8b6f47]/10 transition-all group/toggle z-10 relative shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Mở rộng bảng thanh toán"><Comp_qs size={24} strokeWidth={3} className="group-hover/toggle:-translate-x-0.5 transition-transform" style={getButtonComputedStyle(cartColorConfig, "toggle").color ? { color: getButtonComputedStyle(cartColorConfig, "toggle").color } : undefined} /></x.button></div><div className="flex flex-col gap-3 pb-4 px-3"><x.button whileHover={{
                        scale: 1.08
                      }} whileTap={{
                        scale: 0.92
                      }} onClick={wr} disabled={y.length === 0} style={getButtonComputedStyle(cartColorConfig, 'hold')} className="w-14 h-14 bg-[#fbf9f4] dark:bg-[#1a1e17] text-[#8b6f47] dark:text-[#d4a574] border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 rounded-2xl flex items-center justify-center hover:border-[#8b6f47] hover:bg-[#8b6f47]/15 disabled:opacity-30 disabled:pointer-events-none transition-all shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Treo đơn"><Comp_jt size={20} strokeWidth={2.5} style={getButtonComputedStyle(cartColorConfig, "hold").color ? { color: getButtonComputedStyle(cartColorConfig, "hold").color } : undefined} /></x.button><x.button whileHover={{
                        scale: 1.08
                      }} whileTap={{
                        scale: 0.92
                      }} onClick={() => Re(!1)} disabled={y.length === 0 || Be} style={getButtonComputedStyle(cartColorConfig, 'save')} className="w-14 h-14 bg-[#fbf9f4] dark:bg-[#1a1e17] text-[#2d5016] dark:text-emerald-400 border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 rounded-2xl flex items-center justify-center hover:border-[#2d5016] hover:bg-emerald-500/10 disabled:opacity-30 disabled:pointer-events-none transition-all shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Lưu đơn">{Be ? <div className="w-5 h-5 border-2 border-[#2d5016]/20 border-t-[#2d5016] dark:border-emerald-400/20 dark:border-t-emerald-400 rounded-full animate-spin" /> : <Er size={22} strokeWidth={2.5} style={getButtonComputedStyle(cartColorConfig, "save").color ? { color: getButtonComputedStyle(cartColorConfig, "save").color } : undefined} />}</x.button><x.button whileHover={{
                        scale: 1.08,
                        y: -1
                      }} whileTap={{
                        scale: 0.92
                        ...
                        scale: 0.92
                      }} onClick={v} style={getButtonComputedStyle(cartColorConfig, 'theme')} className="w-14 h-14 bg-[#fbf8f2] dark:bg-[#1a1e17] text-[#8b6f47] dark:text-[#d4a574] border-2 border-[#8b6f47]/40 dark:border-[#d4a574]/30 rounded-2xl flex items-center justify-center hover:border-[#2d5016] dark:hover:border-emerald-400 hover:text-[#2d5016] transition-all shadow-[0_8px_18px_rgba(139,111,71,0.22)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.6)] hover:shadow-[0_12px_24px_rgba(139,111,71,0.28)]" title="Chuyển đổi giao diện Sáng / Tối"><Bn size={20} strokeWidth={2.5} style={getButtonComputedStyle(cartColorConfig, "theme").color ? { color: getButtonComputedStyle(cartColorConfig, "theme").color } : undefined} /></x.button>}</div></x.div>}</P></div></x.div>}</div><P>{dr && <Wn isOpen={dr} partner={{
              name: on,
              is_customer: !0,
              is_supplier: !1
                    ...
                    <button
                      ...
                      onClick={() => {
                        const sampleAmount = "năm mươi nghìn đồng",
                          ...
                          sampleTotal = (pc || "dạ {amount} đồng").replace("{amount}", sampleAmount).replace(/{partner}/gi, samplePartner),
                          sampleThanks = (hc || "Cảm ơn quý khách").replace(/{partner}/gi, samplePartner),
